...
<template>
  <NuxtLayout
    name="sidebar"
    :loading="pending"
    :error="error || (!post && `Post with ID '${slug}' not found`) || undefined"
    affix
  ...
  >
    ...
    <div class="container">
      <div class="flex-col flex-auto h-full mt-7 md:mt-0">
        <div
        ...
        <div
          class="flex flex-col flex-auto mt-3 lg:flex-row lg:items-center mb-7 md:mb-12"
        >
